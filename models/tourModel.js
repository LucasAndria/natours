...
const tourSchema = new mongoose.Schema(
  {
    ...
    ratingsAverage: {
      ...
      // set est appeler à chaque fois qu'une valeur est placer à ce champ
    ...
    priceDiscount: {
      ...
      validate: {
        validator: function (val) {
          // This marche seulement si on créer un doc et non avec les updates
...
// // DOCUMENT MIDDLEWARE : runs on .save() and .create() to get the posted objects

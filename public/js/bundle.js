...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var _require = require('./alerts'),
  showAlert = _require.showAlert;
exports.bookTour = function (tourId) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            (0, _alerts.showAlert)('success', "welcome ".concat(name, " !"));
...
var visaForm = document.querySelector('.form_visa');
...
if (signupForm) {
  ...
  var passwordConfirmDom = document.getElementById('passwordConfirm');
  emailDom.addEventListener('click', function (e) {
    e.target.classList.remove('input-error');
  });
  passwordConfirmDom.addEventListener('click', function (e) {
    e.target.classList.remove('input-error');
  });
  signupForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var name, email, password, passwordConfirm, res;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
            ...
            case 7:
              ...
              if (res.split(':')[0] === 'Duplicate field value') {
                (0, _alerts.showAlert)('error', 'email already taken !');
                emailDom.classList.add('input-error');
              }
              if (res === 'Password are not the same') {
                (0, _alerts.showAlert)('error', 'Password are not the same !');

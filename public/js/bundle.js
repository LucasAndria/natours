        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _context2.abrupt("return", cardNumber.classList.add('error'));
            case 9:
              if (nameValue) {
                _context2.next = 11;
                break;
              }
              return _context2.abrupt("return", name.classList.add('error'));
            case 11:
              if (ccvValue) {
                _context2.next = 13;
                break;
              }
              return _context2.abrupt("return", ccv.classList.add('error'));
            case 13:

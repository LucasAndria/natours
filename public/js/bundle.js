...
var bookingCheckoutForm = document.querySelector('.form--booking-checkout');
...
if (bookingCheckoutForm) {
  bookingCheckoutForm.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              tour = document.getElementById('btnPay').dataset.tour;
              user = document.getElementById('btnPay').dataset.user;
              price = document.getElementById('btnPay').dataset.price; // 2) Procceder au payement
              (0, _payment.payTour)(tour, user, price);
            case 6:
            case "end":
              return _context2.stop();
          }
